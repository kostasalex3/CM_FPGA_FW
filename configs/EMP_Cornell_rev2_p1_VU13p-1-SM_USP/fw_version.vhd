...
package FW_TIMESTAMP is
  ...
  constant TS_SEC      : std_logic_vector(7 downto 0) := x"25";
...
package FW_VERSION is
  ...
  constant FW_HASH_1     : std_logic_vector(31 downto  0) := x"585434fb";
  constant FW_HASH_2     : std_logic_vector(31 downto  0) := x"f4548b77";
  constant FW_HASH_3     : std_logic_vector(31 downto  0) := x"48c5f28d";
  constant FW_HASH_4     : std_logic_vector(31 downto  0) := x"14af4450";
  constant FW_HASH_5     : std_logic_vector(31 downto  0) := x"1effed7f";
